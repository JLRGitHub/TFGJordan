...
import pojos.Usuario;
    /**
     * Este servidor modifica un usuario
     */
public class ServidorModificarUsuario extends Thread{
    ...
    public void run() {
        try {
           ...
           while(true)
           {
            ...
            Logger.getLogger(ServidorModificarUsuario.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    */
    public void gestionarDialogo(Socket clienteConectado) throws ExcepcionJordan {
        try {
            ...
            c.modificarUsuario(usuario1);
            System.out.println("Usuario "+usuario1.getNombre()+" modificado con exito");
